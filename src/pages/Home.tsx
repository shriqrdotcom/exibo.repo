...
export default function Home() {
  ...
  return (
    <div className="flex flex-col">
      ...
      {/* Footer */}
      <footer className="bg-[#FDFCF0] dark:bg-charcoal/95 text-charcoal dark:text-cream px-8 py-12 pb-32 mt-12 border-t border-gold/10">
        <div className="max-w-md mx-auto space-y-8">
          ...
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            <div className="flex gap-4">
              {[Instagram, Facebook, Twitter].map((Icon, i) => (
                <a key={i} href="#" className="w-8 h-8 rounded-full bg-charcoal/5 dark:bg-white/5 flex items-center justify-center text-charcoal/40 dark:text-cream/40 hover:bg-saffron hover:text-white transition-all">
          ...
          <div className="grid grid-cols-1 gap-4 pt-8 border-t border-gold/5">
